-- ALTER 
-- ALTER IN MYSQL COMMAND IS A DDL, WHICH STANDS FOR (DATA DEFINITION LANGUAGE) STATEMENT. ALTER IS USED TO UPDATE THE STRUCTUREVOF THE TABLE IN THE DATABASE E.G ( LIKE, ADD, DELETE, MODIFY THE ATTRIBUTE OF THE TABLE IN THE DATABASE)
...
#                ANSWER 4  
        ...
        SHOW INDEX FROM tbl_Students_2025 ;
ALTER TABLE tbl_students_2025
DROP INDEX EMAIL_3;
